...
#~ イベント：スクリプトに記入します。 
#~ 例１：マップIDが12、イベントIDが2、13、18、25、40のセルフスイッチＡをオンにする場合 
#~ rx_self_sw(12, [2, 13, 18, 25, 40], "A") 


#~ 例２：イベント作成中のマップ内のイベントIDが2、13、18、25、40のセルフスイッチＢをオフにする場合 
#~ rx_self_sw([2, 13, 18, 25, 40], "B", "off") 
#~ "off"の所は、"on"以外の文字列であれば何でもオフになります。 
