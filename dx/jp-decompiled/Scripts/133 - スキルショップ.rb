...
module WD_skillshop_ini
  ...
  Gold_variable_id   = 2     #変数の番号
  Gold_variable_name = "GP" #変数の名前
  Gold_variable_unit = "GP"   #変数の単位
  ...
  #データベース上で、スキルのメモ欄に「<価格:3000>」と記述すると
  #価格が3000G(または必要変数が3000)になります。
  
#~   Skill_list[0]  = [137,140,144,148,152,156,160,167,171,173,177,178,182,183,184,185,186,190,194,195,196,197,198,202,203]
#~   
#~   Skill_list[1]  = [222,235,238,241,251,293,296,299,302,305,308,404,407,410,413,416,513]
#~   Skill_list[2]  = [222,229,235,293,296,299,302,305,308,416,514]
#~   Skill_list[3]  = [223,229,232,235,238,241,244,263,293,296,299,302,305,308,323,326,329,332,413,515]
#~   Skill_list[4]  = [224,244,269,293,296,302,353,356,359,407,413,416,449,519]
#~   Skill_list[5]  = [222,241,251,293,296,302,305,404,407,410,413,416,517]
#~   Skill_list[6]  = [224,263,266,293,296,302,305,353,356,359,518]
#~   Skill_list[7]  = [224,275,278,293,296,302,305,443,446,449,520]
#~   Skill_list[8]  = [483,486,492,498,999]
#~   
#~  
#~   Skill_list[9]  = [651,652,653,654,532]

     Skill_list[5]  = [755,756,757,574,575,576]
  
  #以下、各_list[1]  = []アクターが修得できないスキルを指定
