...
module WD_skillpoint_ini
 ...
 #必要であることを意味します。
 Skilllearn[1] = ["体力向上","353;3","362;5","202;6","363;8","370;12","383;15","376;18","381;25","382;30","389;35","404;45","332;50",]
 Skilllearn[2] = ["魔法実習","252;4","364;6","255;10","369;12","377;16","387;19","178;20","258;22","390;30","396;35","261;40","211;50","335;60",]
 Skilllearn[3] = ["剣技","154;5","365;7","184;9","384;12","371;16","386;19","331;20","160;22","378;25","181;28","391;30","395;35","405;42","205;45","406;48","166;50","223;65",]
 Skilllearn[4] = ["勉学","285;6","366;9","388;13","372;15","288;16","175;19","379;22","392;30","169;35","398;40","187;45","401;48","172;55","321;68",]
 Skilllearn[5] = ["瞑想","356;5","367;6","208;9","373;11","133;12","385;15","380;18","333;20","271;21","318;22","393;25","291;32","399;40","327;42","402;45","334;55",]
 Skilllearn[6] = ["休息","361;4","368;8","374;15","375;20","394;30","397;35","400;40","403;50","407;60",]
 ...
 #各名称の設定
 Sp_name = "スキルポイント"   #スキルポイントの名前
 Sp_dimention = "PP"           #スキルポイントの単位
 Result_text = "スキルの修得" #スキル修得ウィンドウのテキスト
 Master_sign = "MASTER"       #修得済みのスキルに対する表記
 Master_sign2 = "MASTER"       #コンプリート済みの親スキルに対する表記

 #確認用メッセージ
 Confirm_mess = "スキルポイントを分配してよろしいですか？"
 Confirm_yes = "　はい"
 Confirm_no  = "　いいえ"
...
class Window_SPActorSp < Window_Selectable
  ...
  def refresh
    ...
    draw_text(0,0,440,24, "#{WD_skillpoint_ini::Sp_name} 残り", 2)
